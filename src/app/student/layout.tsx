...
export default function StudentLayout({ children }: { children: React.ReactNode }) {
  return (
    <AuthGuard requiredRole="student">
      <PortalLayout
        role="student"
        title="Gracemark Academy — Student Portal"
        subtitle="Academic performance, report card download, and school fees"
