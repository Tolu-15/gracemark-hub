    ...
    <div className="max-w-lg mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">
          Update your teacher account password. You'll need your current password to confirm.
        </p>
      </div>
      ...
      <div className="bg-white border border-slate-200/80 rounded-2xl shadow-xs p-6 sm:p-8">
        {success ? (
          <div className="text-center py-6 space-y-4">
            ...
            <p className="text-sm text-slate-500">Your new password is active.</p>
            <button
              type="button"
                    ...
                    return (
                      <div
                        ...
                        className={`h-1 flex-1 rounded-full transition-colors ${
                          lvl <= score
                            ? score <= 1 ? "bg-rose-400" : score <= 2 ? "bg-amber-400" : score <= 3 ? "bg-yellow-400" : "bg-emerald-500"
                            : "bg-slate-200"
                        }`}
                      />
                    );
